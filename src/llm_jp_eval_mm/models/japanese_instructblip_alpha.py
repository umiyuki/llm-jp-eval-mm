...
@register_model("japanese-instructblip-alpha")
class JapaneseInstructBLIPAlpha(lmms):
    """
    JapaneseInstructBLIPAlpha Model
    """

    def __init__(
        self,
        # pretrained: str = "stabilityai/japanese-instructblip-alpha",
